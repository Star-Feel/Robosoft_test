...
def main():
    for i in [26, 3]:
        ...
        data_path = f"./work_dirs/rod_control_data/full/{i}/info.json"
        work_dir = f"./work_dirs/rod_control_demo/{i}"
        ...
        with tqdm(
            ...
            for i in progress_steps:
                ...
                pbar.update(1)
                global_step += 1
                if not any(env.action_flags) and \
                        env.attach_flags[info["object_id"]]:
